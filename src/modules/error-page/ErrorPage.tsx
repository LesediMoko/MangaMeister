...
const ErrorPage = () => {
    return (
        <div style={{ backgroundImage: "url(/bg-nimbus-3.png)", backgroundPosition: "50% 50%" }} className="m-0 h-svh flex flex-col md:bg-no-repeat md:bg-cover md:bg- md:bg-[#E84136]">
