...
const ContinueReading = ({ manga, scrollPosition }: { manga: ISelectedManga, scrollPosition: { chapterID: string, position: number } }) => {
    return (
        <div className="w-full md:w-1/2 md:place-self-center lg:w-1/3 shadow-xl flex flex-col gap-10 justify-center h-40 relative items-center text-center bg-cover mb-10" style={{ backgroundImage: `url('${manga.coverImage}')`, backgroundPosition: "top", backgroundRepeat: "no-repeat" }}>
